...
intro_background=pygame.image.load("fback.jpg")
...
def intro_loop():
    ...
    while intro:
        ...
        button("START",550,230,100,50,green,bright_green,"play")
        button("QUIT",550,370,100,50,red,bright_red,"quit")
        button("INSTRUCTION",520,300,200,50,blue,bright_blue,"intro")
...
def countdown_background():
    ...
    button("PAUSE",620,50,150,50,turq,turq,"pause")
...
def game_loop():
    ...
    while not bumped:
        ...
        if obs_starty>display_height:
            ...
            obs_startx=random.randrange(100,(display_width-170))
